...
* 從 iTunes Store 是否一定要輸入密碼，建議**學生機設定為限制**
...
* 根據教學狀況設定，停用則使用者無法清除 Safari 歷史紀錄
...
* 根據教學狀況設定，停用則使用者無法使用 Safari 私密瀏覽
...
* 控管裝置可以使用的 App
    ...
    * 👩‍🎓 學生機建議設定：不允許部份 App，可以參考 [iPhone 和 iPad Apple App 的套件識別碼](https://support.apple.com/zh-tw/guide/deployment/depece748c41/web)，將內建的 App 關閉，減少教學干擾
